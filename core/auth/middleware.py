...
class AuthMiddleware:
    ...
    def _authenticate_request(self):
        ...
        from .kratos_client import get_kratos_client, AuthenticationError, SessionExpiredError
...
def require_auth(f: Callable) -> Callable:
    ...
    def decorated_function(*args, **kwargs):
        ...
        if g.current_user is None:
            ...
            error_msg = getattr(g, 'auth_error', 'Please log in to access this resource')
            return jsonify({
                "error": "Authentication required",
                "message": error_msg,
                "code": "AUTH_REQUIRED"
