...
if _te_data:
    THERMAL_EXPANSION_COEFFICIENTS: Dict[str, float] = {
        name: props['value'] for name, props in _te_data.items()
...
MATERIALS['ferro frit 3124'] = Material(
    ...
    oxides={'Na2O': 12.0, 'K2O': 5.0, 'CaO': 10.0, 'B2O3': 15.0, 'Al2O3': 10.0, 'SiO2': 48.0},
    loi=0.0,
    category='frit',
)
...
MATERIALS['ferro frit 3134'] = Material(
    ...
    oxides={'Na2O': 4.7, 'K2O': 1.8, 'CaO': 16.5, 'Al2O3': 9.3, 'B2O3': 9.1, 'SiO2': 47.2, 'MgO': 3.7},
    loi=0.0,
    category='frit',
)
...
MATERIALS['alkalifritte m1233'] = Material(
    ...
    aliases=['m1233'],
    oxides={'Na2O': 8.0, 'K2O': 5.0, 'CaO': 12.0, 'Al2O3': 10.0, 'B2O3': 8.0, 'SiO2': 55.0, 'ZnO': 2.0},
    loi=0.0,
    category='frit',
)
