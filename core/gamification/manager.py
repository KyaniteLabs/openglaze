...
class GamificationManager:
    ...
    def on_combination_tested(self, user_id: str, combo_id: int, status: str, is_surprise: bool = False):
        ...
        # Log activity
        self.log_activity(user_id, 'combination_tested', {'combination_id': combo_id, 'status': status})
